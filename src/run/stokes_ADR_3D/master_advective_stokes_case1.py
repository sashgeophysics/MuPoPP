...
def load_mesh(mesh_fname,extension, Lmax=1.0e3):
    ...
    value is set at 1.0e3 micron, 1 mm. Change this value for experimenting with
    the length scale."""
...
ca_init=Expression("0.1",degree=1)
anorthite = 0.1
# Initial velocity
...
file_name      = "BFS2_dt_%.1E_An_%3.2f_Da_%.1E_Pe_%.1E"%(dt0,anorthite,Da0,Pe0)
