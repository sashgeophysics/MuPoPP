...
mesh = RectangleMesh(Point(xmin,ymin),Point(xmax,ymax), 150, 150,"crossed")
#mesh = RectangleMesh(Point(0.0, 0.0), Point(4.0, 1.0), 50, 50)
#plot(mesh)
#plt.show()
...
##############Create an object
darcy=DarcyAdvection(Da=10.0,phi=0.01,Pe=1.0e6)
