...
darcy = DarcyAdvection(Da=Da0,Pe=Pe0,cfl=cfl0)
...
while t - T < DOLFIN_EPS:
    ...
    a,L=darcy.stokes_no_alpha(W,mesh,sol_prev=sol_initial,dt=dt0,K=0.1,zh=Constant((1.0,0.0,0.0)))
